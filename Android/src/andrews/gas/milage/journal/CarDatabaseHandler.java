...
public class CarDatabaseHandler extends SQLiteOpenHelper
{
	...
	public void onCreate(SQLiteDatabase db)
	{
		String CREATE_FILL_UP_TABLE = "CREATE TABLE " + TABLE_FILL_UPS + "("
				+ KEY_NAME + " TEXT," + KEY_YEAR + " INTEGER," + KEY_MAKE
				+ " TEXT," + KEY_MODEL + " TEXT," + KEY_MILES + " Double" + ")";
	...
	Car getCar(int id)
	{
		...
		Cursor cursor = db.query ( TABLE_FILL_UPS , new String[] { KEY_NAME,
				KEY_YEAR, KEY_MAKE, KEY_MODEL, KEY_MILES } , KEY_NAME + "=?" ,
				new String[] { String.valueOf ( id ) } , null , null , null ,
				null );
		if ( cursor != null )
			cursor.moveToFirst ( );

		Car car = new Car ( cursor.getString ( 0 ), cursor.getInt ( 1 ),
	...
	{
		SQLiteDatabase db = this.getWritableDatabase ( );
		db.delete ( TABLE_FILL_UPS , KEY_NAME + " = ?" ,
				new String[] { String.valueOf ( car.name ) } );
		db.close ( );
	}
