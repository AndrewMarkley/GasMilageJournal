...
public class Stats extends Activity
{
	...
	Button carP = null;
	double avg_mpg = 0;
	double avg_fuel_cost = 0;
	double avg_miles_per_dollar = 0;
	double avg_time_between_fill_ups = 0;
	double avg_miles_between_fill_ups = 0;
	double avg_dollar_per_day = 0;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		try {
			...
			String[] ans = { "" + avg_mpg, "" + avg_miles_between_fill_ups,
					"" + avg_miles_per_dollar, "" + avg_dollar_per_day,
					"" + avg_fuel_cost,
					"" + avg_time_between_fill_ups + " days" };
			...
			SimpleAdapter adapter = new SimpleAdapter( getBaseContext( ),
					aList, R.layout.stats_list_view, from, to );
	...
	private class fillUpComparator implements Comparator<FillUp>
	{
		@Override
