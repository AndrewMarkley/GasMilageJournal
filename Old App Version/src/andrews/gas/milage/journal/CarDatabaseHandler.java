...
public class CarDatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        + KEY_ID + " INTEGER," + KEY_NAME + " TEXT," + KEY_YEAR + " INTEGER," 
    ...
    void addCar(Car car) {
        ...
        values.put(KEY_ID, car.getID()); // MPG
    ...
    Car getCar(int id) {
        ...
        Cursor cursor = db.query(TABLE_FILL_UPS, new String[] { KEY_ID, KEY_NAME, KEY_YEAR, KEY_MAKE, KEY_MODEL }, KEY_ID + "=?",    
                new String[] { String.valueOf(id) }, null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
 
        Car car = new Car(cursor.getInt(0), cursor.getString(1), cursor.getInt(2), cursor.getString(3), cursor.getString(4), cursor.getDouble(5));
        // return contact
        return car;
    }
    ...
    public int updateCar(Car car) {
        ...
        // updating row
        return db.update(TABLE_FILL_UPS, values, KEY_ID + " = ?", new String[] { String.valueOf(car.getID()) });
    }
 
    // Deleting single contact
    public void deleteCar(int id) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TABLE_FILL_UPS, KEY_ID + " = ?", new String[] { String.valueOf(id) });
        db.close();
    }
