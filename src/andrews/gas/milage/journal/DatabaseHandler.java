...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        + KEY_CAR + " TEXT," + KEY_DISTANCE + " DOUBLE," + KEY_GAS + " DOUBLE," 
    ...
    FillUp getFillup(int id) {
        ...
        FillUp contact = new FillUp(cursor.getString(0), cursor.getDouble(1), cursor.getDouble(2), cursor.getDouble(3), cursor.getDouble(4), cursor.getDouble(5), cursor.getString(6), cursor.getString(7));
        // return contact
        return contact;
    }
    ...
    public List<FillUp> getAllFillUps() {
        ...
        if (cursor.moveToFirst()) {
            do {
                FillUp fu = new FillUp(cursor.getString(0), cursor.getDouble(1), cursor.getDouble(2), cursor.getDouble(3), cursor.getDouble(4), cursor.getDouble(5), cursor.getString(6), cursor.getString(7));
