...
public class showServiceLog extends Activity {
    ...
    int tempPos;
    String[] values = null;
    Button b5, b6, b4, service_log, carP = null;
    Context cx = null;
	@Override
	public void onCreate(Bundle savedInstanceState) {
        ...
        //b4  = (Button) findViewById(R.id.car_service_log_button); //Fill up screen
        ...
        //need to implement this as a car profile object instead of services, that goes in service log form
    	/*String servicesArray[] = new String[]{"Oil Change", "New Tires", "Rotate Tires", "Brakes" };
	    adapter =  new ArrayAdapter <CharSequence> (this, android.R.layout.simple_spinner_item, servicesArray);

        spinner.setAdapter(adapter);
        listView = (ListView) findViewById(R.id.car_service_list);
        db = new ServiceLogDataBaseHandler(this);
        try{
        	services = (ArrayList<ServiceLog>) db.getAllServiceLogs();            
        } catch(Exception e){
        } */       
        /*
			...
			public boolean onItemLongClick(AdapterView<?> a, View view, int pos, long arg3) 
			{
	            ...
	            builder.setItems(options, new DialogInterface.OnClickListener() 
	            {
						...
						public void onClick(DialogInterface dialog, int p) 
	                    {
	                    	   ...
	                    	   {
	                    		   ServiceLog c = services.remove(tempPos);
	                    		   System.out.println("REMOVING: "+c.toString());
	                    		   db.deleteServiceLog(c, tempPos);
	                    		   services = (ArrayList<ServiceLog>) db.getAllServiceLogs();
	                    	        
	                    	        //adapter = new ArrayAdapter<String>(adapter.getContext(), android.R.layout.simple_list_item_1, android.R.id.text1, values);
        ...
        */
        ...
        /*spin.setOnClickListener(new View.OnClickListener() {
    		...
    		public void onClick(View v) {
	    		...
	    		Log.i("here", "hello");
	    		AlertDialog.Builder build = new AlertDialog.Builder(cx);
	            build.setTitle("Choose a car");
