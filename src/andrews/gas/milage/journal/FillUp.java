...
public class FillUp {
	...
	Calendar cal = null;
	String car = "";
	public FillUp(String carname, double d, double g, double p, String da, String c)
	{
		distance = d;
		gas = g;
		price = round(p, 2);
	...
	public FillUp(String carname, double d, double g, double p, double tc, double mp,  String da, String c)
	{
		distance = d;
		gas = g;
		price = round(p, 2);
