...
public class CarDatabaseHelper extends OrmLiteSqliteOpenHelper {
	 ...
	 * call to {@link #close()}.
	 */
	public synchronized CarDatabaseHelper getHelper(Context context) {
		if (helper == null) {
	...
	public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
		try {
			...
			dao.create(car);
			car = new Car("name1", 2000, "make1", "model1", 75001);
			dao.create(car);
	...
	/**
	 * Returns the Database Access Object (DAO) for our Car class. It will create it or just give the cached
	 * value.
	 */
